...
class test_reply_in_forum:
    ...
    def test_reply_in_forum1(self):
        wait = WebDriverWait(self.driver, 60)

        # Navigate to the forum and add a discussion topic
        self.driver.find_element(By.LINK_TEXT, "My courses").click()
        wait.until(EC.visibility_of_any_elements_located(
            (By.CSS_SELECTOR, "#course-info-container-2-3 .multiline")))
        ...
        wait.until(EC.element_to_be_clickable(
            (By.LINK_TEXT, "Test topic"))).click()

        self.driver.find_element(By.ID, "id_subject").send_keys("Test topic")
        self.driver.switch_to.frame(0)
        self.driver.find_element(By.CSS_SELECTOR, "html").click()
        element = self.driver.find_element(By.ID, "tinymce")
        self.driver.execute_script(
            "if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>Hi you guys.</p>'}", element)
        self.driver.switch_to.default_content()
        self.driver.find_element(By.ID, "id_submitbutton").click()

        # Wait for the discussion topic to be added
        wait.until(EC.element_to_be_clickable(
            (By.LINK_TEXT, "Test topic"))).click()

        # Reply to the discussion topic
        self.driver.find_element(By.LINK_TEXT, "Reply").click()
        self.driver.find_element(By.NAME, "post").send_keys(
            "Thank you for your information.")

        # Wait for the reply button to be clickable
        wait.until(EC.element_to_be_clickable(
            (By.CSS_SELECTOR, ".btn-primary:nth-child(1) > span:nth-child(1)"))).click()

    def test_reply_in_forum2(self):
        self.driver.find_element(By.LINK_TEXT, "My courses").click()
        self.driver.find_element(
            By.CSS_SELECTOR, "#course-info-container-2-3 .multiline").click()
        self.driver.find_element(
        ...
        self.driver.find_element(By.NAME, "post").send_keys(
            "Thank you for your information")
        self.driver.find_element(By.CSS_SELECTOR, ".form-check").click()
        self.driver.find_element(By.ID, "private-reply-checkbox-0").click()
        self.driver.find_element(
            By.CSS_SELECTOR, ".btn-primary:nth-child(1) > span:nth-child(1)").click()

    def test_reply_in_forum3(self):
        self.driver.find_element(By.LINK_TEXT, "My courses").click()
        self.driver.find_element(
            By.CSS_SELECTOR, "#course-info-container-2-3 .multiline").click()
        self.driver.find_element(
    ...
    def test_reply_in_forum5(self):
        ...
        self.driver.find_element(By.LINK_TEXT, "Test topic").click()
        self.driver.find_element(By.LINK_TEXT, "Reply").click()
        self.driver.find_element(By.NAME, "post").send_keys("T")
        self.driver.find_element(
            By.CSS_SELECTOR, ".btn-primary:nth-child(1) > span:nth-child(1)").click()

    def test_reply_in_forum6(self):
        self.driver.find_element(By.LINK_TEXT, "My courses").click()
        self.driver.find_element(
            By.CSS_SELECTOR, "#course-info-container-2-3 .multiline").click()
        self.driver.find_element(
    ...
    def test_reply_in_forum10(self):
        self.driver.find_element(By.LINK_TEXT, "My courses").click()
        self.driver.find_element(
            By.CSS_SELECTOR, "#course-info-container-2-3 .multiline").click()
        self.driver.find_element(
    ...
    def run(self):
        ...
        test = self.test_reply_in_forum1()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum1.__name__)
        self.teardown_method(None)

        # test case 2
        self.setup_method()
        self.login_teacher_account()
        test = self.test_reply_in_forum2()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum2.__name__)
        self.teardown_method(None)

        # test case 3
        self.setup_method()
        self.login_teacher_account()
        test = self.test_reply_in_forum3()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum3.__name__)
        self.teardown_method(None)

        # test case 4
        self.setup_method()
        self.login_teacher_account()
        test = self.test_reply_in_forum4()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum4.__name__)
        self.teardown_method(None)

        # test case 5
        self.setup_method()
        self.login_teacher_account()
        test = self.test_reply_in_forum5()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum5.__name__)
        self.teardown_method(None)
        ...
        self.setup_method()
        self.login_teacher_account()
        test = self.test_reply_in_forum6()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum6.__name__)
        self.teardown_method(None)

        # test case 7
        self.setup_method()
        self.login_teacher_account()
        test = self.test_reply_in_forum7()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum7.__name__)
        self.teardown_method(None)

        # test case 8
        self.setup_method()
        self.login_teacher_account()
        test = self.test_reply_in_forum8()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum8.__name__)
        self.teardown_method(None)

        # test case 9
        self.setup_method()
        self.login_teacher_account()
        test = self.test_reply_in_forum9()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum9.__name__)
        self.teardown_method(None)

        # test case 10
        self.setup_method()
        self.login_teacher_account()
        test = self.test_reply_in_forum10()
        result.append(test)
        if not test:
            fail_test_name.append(self.test_reply_in_forum10.__name__)
        self.teardown_method(None)

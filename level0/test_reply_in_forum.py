...
class test_reply_in_forum:
  ...
  def test_reply_in_forum1(self):
    ...
    # wait.until(EC.visibility_of_element_located((By.CSS_SELECTOR, "#course-info-container-2-3 .multiline")))

    wait.until(EC.visibility_of_any_elements_located((By.CSS_SELECTOR, "#course-info-container-2-3 .multiline")))

    self.driver.find_element(By.CSS_SELECTOR, "#course-info-container-2-3 .multiline").click()

    wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, ".modtype_forum .aalink"))).click()
    ...
    wait.until(EC.element_to_be_clickable((By.LINK_TEXT, "Test topic"))).click()
    ...
    self.driver.execute_script("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '<p>Hi you guys.</p>'}", element)
    ...
    self.driver.find_element(By.NAME, "post").send_keys("Thank you for your information.")
    
    # Wait for the reply button to be clickable
    wait.until(EC.element_to_be_clickable((By.CSS_SELECTOR, ".btn-primary:nth-child(1) > span:nth-child(1)"))).click()
  ...
  def test_reply_in_forum2(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "#course-info-container-2-3 .multiline").click()
    self.driver.find_element(By.CSS_SELECTOR, ".modtype_forum .aalink").click()
    element = self.driver.find_element(By.CSS_SELECTOR, ".search-icon > .icon")
    ...
    self.driver.find_element(By.CSS_SELECTOR, ".btn-primary:nth-child(1) > span:nth-child(1)").click()
